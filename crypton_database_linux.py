...
class DatabaseApp():
    def __init__(self):
        ...
        # Данные по умолчанию
        self.cursor.execute(
            'INSERT OR IGNORE INTO smbconnectconfig VALUES (1, "По умолчанию", "192.168.0.100", "username", "password", "SAMBA", "server-terminal", "sharename", "/distr/certificates", "/var/opt/cprocsp/keys/user/", "/distr/certs_password.txt")')
        self.conn.commit()
